...
MEC= mecdynamics.o mecevent.o mecevent_tem.o mecevent_Nieves.o mecevent_2020Valencia.o mecevent_2024Valencia.o mecevent_SuSA.o\
...
$(BIN)/reweight_along: $(addprefix src/, \
	...
	mecdynamics2.o mecevent2.o mecevent_tem.o mecevent_Nieves.o mecevent_2020Valencia.o mecevent_2024Valencia.o mecevent_SuSA.o mecevent_common.o\
        qel_sigma.o kinsolver.o kinematics.o pdg.o target_mixer.o nucleus.o  sfevent.o ff.o dirs.o rpa_2013.o nucleus_data.o isotopes.o elements.o \
